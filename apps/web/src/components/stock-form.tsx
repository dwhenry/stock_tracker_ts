...
export function StockForm({
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await fetch(`/api/customers/${customerId}/stocks/${stockId}`, { method: "PATCH", body: fd });
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        <input id="quantity" name="quantity" type="number" min={0} required defaultValue={defaultQuantity} />
      </div>
      <div className="form-group">
